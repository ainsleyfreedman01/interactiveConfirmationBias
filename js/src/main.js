        ...
        dataFactRows.append("div")
            ...
            .html(function (d) {
                ...
                if (uniqueAlternativeVisualizationsForFact.length > 0) {
                    return "<table style='width: 100%;'><tr style='width: 100%;'>" +
                        "<td style='width:90%;border: none;'>" + d.activeHtml + "</td>" +
                        "<td style='border: none;' class='activeVisFactButtons'>" +
                        "<i class='removeButton fa fa-remove' style='float: right;' value='" + JSON.stringify(d) + "'></i>" +
                        "<i class='acceptButton fa fa-star' style='float: right; margin-right: 15%;' value='" + JSON.stringify(d) + "'></i>" +  // Added margin-right here
                        "<i class='fa fa-eye' style='float: right; margin-right: 20%;' title='Click to see " + uniqueAlternativeVisualizationsForFact.length + " alternate visualization(s).'></i>" +
                        "</td>" +
                        "</tr></table>";
                } else {
                    return "<table style='width: 100%;'><tr style='width: 100%;'>" +
